...
export const signMessage = async (msg: string | Uint8Array, id: string, walletId: string, projectId: string, credentialId: string, apiUrl = API_URL) => {
...
export const signTypedData = async (params: SignTypedDataParams, id: string, walletId: string, projectId: string, credentialId: string, apiUrl = API_URL) => {
  const hashToSign = hashTypedData(params)
  return await signMessage(hashToSign, id, walletId, projectId, credentialId, apiUrl)
}
