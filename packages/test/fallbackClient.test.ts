...
import { type GreeterAbi, GreeterBytecode } from "./abis/Greeter.js"
...
describe("fallback client e2e", () => {
    ...
    //         const onError = async (error: Error, clientUrl: string) => {
    //             console.error(
    //                 `Error with client ${clientUrl}: ${error.message}`
    //             )
    //         }

    //         fallbackKernelClient = createFallbackKernelAccountClient(
    //             [zerodevKernelClient, pimlicoKernelClient, stackupKernelClient],
    //             onError
    //         ) as KernelAccountClient<
    //             EntryPoint,
    //             Transport,
    ...
    //         const onError = async (error: Error, clientUrl: string) => {
    //             console.error(`Error with client ${clientUrl}: ${error.name}`)
    //         }
