...
import { webauthnGetMultiUserOpDummySignature } from "./webauthnGetMultiUserOpDummySignature.js"

export async function webauthnPrepareMultiUserOpRequest<
...
>({
    ...
    if (userOperation.signature === "0x") {
        userOperation.signature = await webauthnGetMultiUserOpDummySignature(
            userOperation,
            numOfUserOps,
            account.entryPoint,
            chainId
